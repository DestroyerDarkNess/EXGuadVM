...
namespace EXGuardVM.Core
{
    public class MethodTreeLoader
    {
        ...
        public async Task LoadMethodsAsync(IProgress<ProgressEventArgs> progress = null)
        {
            ...
            _methodTree.BeginInvoke((MethodInvoker)(() => _methodTree.Nodes.Clear()));
            _methodTree.BeginInvoke((MethodInvoker)(() => _methodTree.BeginUpdate()));
            ...
            try
            {
                ...
                {
                    _methodTree.BeginInvoke((MethodInvoker)(() => _methodTree.EndUpdate()));
                ...
                _methodTree.BeginInvoke((MethodInvoker)(() => _methodTree.Nodes.AddRange(rootNodes.ToArray())));
            }
            finally
            {
                _methodTree.BeginInvoke((MethodInvoker)(() => _methodTree.EndUpdate()));
